...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibnZhbGxlZSIsImEiOiJjazNjdGJidGIwenBjM2pteHkzaTMwazgzIn0.ViiXGUKd1C3M3-Q79Bn9Gg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/nvallee/ck3ctektf1wqz1cpi5cwgngmk',
    scrollZoom: false // center: [-96.7, 39.2],
    // zoom: 3,
    // interactive: false
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error logging you out, please try again.');
...
/* eslint-disable */
var stripe = Stripe('pk_test_wBQPcIaeNFEP0kSKmFhclToC00s9UoX7A6');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // console.log(`File: ${document.getElementById('photo').files[0]}`);
